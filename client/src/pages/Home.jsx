...
const Home = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      {/* Hero Section */}
      <div className="relative bg-black/70 text-white rounded-3xl overflow-hidden mb-6 -mt-7 shadow-2xl border border-white/10 max-w-8xl mx-auto w-full">
        {/* Background Image */}
        ...
        <div className="relative p-8 md:p-16 text-center flex flex-col items-center z-10">
          {/* Badge */}
          <span className="bg-amber-400/10 text-amber-300 px-4 py-1.5 rounded-full text-xs font-bold tracking-widest uppercase mb-6 border border-amber-400/20">
            Welcome to Bookifyr
          </span>
          ...
          <p className="text-gray-300 text-base md:text-lg mb-10 max-w-2xl mx-auto font-light leading-relaxed">
            Uncover buzzing tech meetups, electric music festivals, and
            immersive workshops happening right around you.
          </p>

          {/* Search Box */}
          <div className="w-full max-w-2xl mx-auto relative flex items-center">
            <FaSearch className="absolute left-6 text-gray-400 text-xl group-focus-within:text-amber-400 transition-colors" />

            <input
              type="text"
              placeholder="Search events by title..."
              className="w-full pl-14 pr-6 py-4 rounded-full text-base text-white bg-black/40 backdrop-blur-md border border-white/10 focus:border-amber-400 focus:outline-none transition-all placeholder-gray-500"
              value={search}
              ...
              <div className="h-48 bg-gray-200 overflow-hidden relative">
                ...
                <div className="absolute top-4 right-4 bg-white/90 backdrop-blur-sm px-3 py-1 rounded-full text-sm font-bold shadow-sm">
                  {event.ticketPrice === 0 ? (
                    ...
                    <span className="text-gray-900">Rs.{event.ticketPrice}</span>
                  )}
                </div>
              </div>
      ...
      <footer className="mt-auto pt-16 pb-8 border-t border-gray-200 text-center">
        <div className="flex justify-center items-center gap-2 mb-4">
          ...
          <span className="text-xl font-bold text-gray-900">Bookifyr</span>
        </div>
        ...
        <div className="text-xs text-gray-400 font-medium uppercase tracking-wider">
          &copy; {new Date().getFullYear()} Bookifyr Platform. All rights
          reserved.
        </div>
      </footer>
    </div>
